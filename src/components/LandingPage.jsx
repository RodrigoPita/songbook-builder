...
import { BookOpen, Music2, FileText, Tags } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex flex-col items-center justify-center p-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl w-full">
                ...
                <Link
                    to="/tags"
                    className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-amber-200 hover:border-amber-400"
                >
                    <div className="flex items-center justify-between mb-4">
                        <Tags className="w-12 h-12 text-amber-600" />
                        <svg className="w-6 h-6 text-amber-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                    </div>
                    ...
                    <p className="text-gray-600 text-lg mb-6">
                        Manage tags across all songs in both collections. Admin access required.
                    </p>
