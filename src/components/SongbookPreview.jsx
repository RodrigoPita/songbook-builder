            ...
            {songs.length === 0 ? (
                ...
                <div id="songbook-preview">
                    {songs.map((song, index) => (
                        ...
                        >
                            {/* Controls Row: Transpose + Remove */}
                            <div className="flex items-center justify-between mb-2 print:hidden">
                                {/* Transpose Controls */}
                                <div className="flex items-center space-x-2">
                                    <label className="text-sm font-medium text-gray-600">Transpor (semitons):</label>
                                    <button
                                    ...
                                    <button
                                        ...
                                        className={`p-2 border border-red-300 rounded-full bg-red-50 text-red-600 transition shadow-sm
                                ...
                                <button
                                    ...
                                    className="p-2 border border-red-300 rounded-full bg-red-50 text-red-600 hover:bg-red-100 transition shadow-sm"
