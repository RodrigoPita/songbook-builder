...
const SongPreviewBlock = ({ song, shift }) => {
    ...
    return (
        <div className="p-3 sm:p-4 lg:p-6 bg-white border border-gray-200 rounded-xl shadow-lg mb-6 break-inside-avoid print:shadow-none print:border-0 print:p-0">
